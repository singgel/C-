...
namespace WebBrowserUtils.HtmlUtils.Fillers
{
    ...
    /// 国环网页填报器。
    /// </summary>
    public sealed class GHFiller : FillBase
    {
        ...
        public GHFiller(WebBrowser2 browser, Uri currentUri, UrlParameter urlParameter)
        ...
        protected override void BeginFillProtected()
        {
            ...
            if (base.CurrentUrl.AbsolutePath == "/newvip/newplan/3/vehicle15.jsp")
                this.HandleSpecialPage();
        ...
        private DataTable GetTableData(string sheetName)
        {
            ...
            using (Office.Excel.ForwardExcelReader reader = new Office.Excel.ForwardExcelReader(this.DataFile))
            {
                ...
                sheetName = string.Format("{0}_{1}", sheetName, base.FillIndexes.Count == 0 ? 1 : base.FillIndexes[0].CurrentIndex + 1);
