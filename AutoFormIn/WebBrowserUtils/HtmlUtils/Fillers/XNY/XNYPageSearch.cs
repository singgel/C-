...
{
    class XNYPageSearch : ElementDetectorBase
    {
        ...
        public XNYPageSearch(List<KeyValuePair<FillParameterKey, object>> searchOption, List<string> valueList, WebBrowser browser)
            :base(browser)
        {
            matchedIndex = 0;
            beginMatch = false;
