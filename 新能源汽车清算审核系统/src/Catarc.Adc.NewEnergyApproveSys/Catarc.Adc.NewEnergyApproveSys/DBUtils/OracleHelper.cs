...
namespace Catarc.Adc.NewEnergyApproveSys.DBUtils
{
    public static class OracleHelper
    {
        ...
        public static readonly string conn = String.Format("Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST={0})(PORT={1}))(CONNECT_DATA=(SERVICE_NAME={2})));User Id={3};Password={4}", Catarc.Adc.NewEnergyApproveSys.Properties.Settings.Default.DataAddr, Catarc.Adc.NewEnergyApproveSys.Properties.Settings.Default.DataPort, Catarc.Adc.NewEnergyApproveSys.Properties.Settings.Default.DataBase, Catarc.Adc.NewEnergyApproveSys.Properties.Settings.Default.DataUserId, Catarc.Adc.NewEnergyApproveSys.Properties.Settings.Default.DataUserPWD);
