...
namespace FuelDataSysServer.Tool
{
    public static class OracleHelper
    {
        ...
        public static readonly string conn = String.Format("Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST={0})(PORT={1}))(CONNECT_DATA=(SERVICE_NAME={2})));User Id={3};Password={4}", FuelDataSysServer.Properties.Settings.Default.DataAddr, FuelDataSysServer.Properties.Settings.Default.DataPort, FuelDataSysServer.Properties.Settings.Default.DataBase, FuelDataSysServer.Properties.Settings.Default.DataUserId, FuelDataSysServer.Properties.Settings.Default.DataUserPWD);
