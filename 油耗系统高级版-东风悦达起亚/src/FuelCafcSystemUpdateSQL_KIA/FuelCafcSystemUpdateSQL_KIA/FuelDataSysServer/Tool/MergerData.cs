            ...
            try
            {
                using (OracleConnection conn = new OracleConnection(OracleHelper.conn))
                {
                    ...
                    try
                    {
                        ...
                        parameters_CLJBXX[22].Value = DateTime.Today.ToString("yyyy-MM-dd HH：mm：ss");
                        parameters_CLJBXX[23].Value = DateTime.Today.ToString("yyyy-MM-dd HH：mm：ss");
                        ...
                        if (bRet)
                        {
                            ...
                            parameters_MERGER_INFO[5].Value = DateTime.Today.ToString("yyyy-MM-dd HH：mm：ss");
