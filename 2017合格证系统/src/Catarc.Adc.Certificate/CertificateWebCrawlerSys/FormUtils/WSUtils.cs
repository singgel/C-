...
namespace CertificateWebCrawlerSys
{
    public class WSUtils
    {
        ...
        public WSUtils(string name, GridControl gc, ListBox lb)
        {
            this.gc = gc;
            this.HtmlName = name;
            this.CrawlerLog = lb;
        }
        public WSUtils(string name, GridControl gc, Label lbl)
        {
            this.gc = gc;
            this.HtmlName = name;
            this.lbl = lbl;
        ...
        private void AutoCrawlerData()
        {
            ...
            //默认400
            int iMaxPageNumm = int.Parse(MaxPageNumm) == 0 ? 400 : int.Parse(MaxPageNumm);
