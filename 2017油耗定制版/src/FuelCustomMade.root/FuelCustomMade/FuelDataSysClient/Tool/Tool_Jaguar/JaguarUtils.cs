    ...
    public class JaguarUtils
    {
        ...
        public string ReadCtnyCOCExcel(string fileName, string folderName, string importType, List<string> cocIdList, string promptMsg)
        {
            ...
            try
            {
                ...
                paramMsg += Utils.VerifyRequired("车辆型号", basicInfo.Clxh);
                ...
                paramMsg += Utils.VerifyRequired("车辆种类", basicInfo.Clzl);
                ...
                paramMsg += Utils.VerifyRequired("汽车生产企业", basicInfo.Qcscqy);
                ...
                paramMsg += Utils.VerifyRequired("座位排数", basicInfo.Zwps);
                ...
                if (basicInfo.Rllx.IndexOf(FcdsFlag) < 0)
                {
                    ...
                    paramMsg += Utils.VerifyRequired("气缸数", ctnyInfo.Qgs);
                    ...
                    paramMsg += Utils.VerifyRequired("排量", ctnyInfo.Pl);
                    ...
                    paramMsg += Utils.VerifyRequired("额定功率", ctnyInfo.Edgl);
                    ...
                    paramMsg += Utils.VerifyRequired("市区工况燃料消耗量", ctnyInfo.Sqgkrlxhl);
                    ...
                    paramMsg += Utils.VerifyRequired("市郊工况燃料消耗量", ctnyInfo.Sjgkrlxhl);
                    ...
                    paramMsg += Utils.VerifyRequired("综合工况燃料消耗量", ctnyInfo.Zhgkrlxhl);
                    ...
                    paramMsg += Utils.VerifyRequired("综合工况CO2排放量", ctnyInfo.Zhgkco2pfl);
                ...
                if (basicInfo.Rllx.IndexOf(FcdsFlag) > -1)
                {
                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        paramMsg += Utils.VerifyRequired("动力蓄电池组种类", fcdsInfo.FCDS_HHDL_DLXDCZZL);

                        fcdsInfo.FCDS_HHDL_DLXDCZZNL = Convert.ToString(r["FCDS_HHDL_DLXDCZZNL"]);
                        paramMsg += Utils.VerifyRequired("动力蓄电池组总能量", fcdsInfo.FCDS_HHDL_DLXDCZZNL);

                        fcdsInfo.FCDS_HHDL_DLXDCBNL = Convert.ToString(r["FCDS_HHDL_DLXDCBNL"]);
                        paramMsg += Utils.VerifyRequired("动力蓄电池组比能量", fcdsInfo.FCDS_HHDL_DLXDCBNL);
                        ...
                        if (!string.IsNullOrEmpty(fcdsInfo.FCDS_HHDL_CDDMSXZHGKXSLC))
                            paramMsg += Utils.VerifyInt(fcdsInfo.FCDS_HHDL_CDDMSXZHGKXSLC) ? "" : "纯电动模式下综合工况续驶里程为整数";
                        ...
                        paramMsg += Utils.VerifyRequired("动力蓄电池组标称电压", fcdsInfo.FCDS_HHDL_DLXDCZBCDY);
                        ...
                        paramMsg += Utils.VerifyRequired("混合动力最大电功率比", fcdsInfo.FCDS_HHDL_HHDLZDDGLB);

                        fcdsInfo.FCDS_HHDL_QDDJFZNJ = Convert.ToString(r["FCDS_HHDL_QDDJFZNJ"]);
                        paramMsg += Utils.VerifyRequired("驱动电机峰值扭矩", fcdsInfo.FCDS_HHDL_QDDJFZNJ);
        ...
        //                            fcdsInfo.FCDS_HHDL_DLXDCZZL = Convert.ToString(r["动力蓄电池组种类"]);
        //                            paramMsg += Utils.VerifyRequired("动力蓄电池组种类", fcdsInfo.FCDS_HHDL_DLXDCZZL);



        //                            fcdsInfo.FCDS_HHDL_DLXDCZZNL = Convert.ToString(r["动力蓄电池组总能量"]);
        //                            paramMsg += Utils.VerifyRequired("动力蓄电池组总能量", fcdsInfo.FCDS_HHDL_DLXDCZZNL);

        //                            fcdsInfo.FCDS_HHDL_DLXDCBNL = Convert.ToString(r["动力蓄电池组比能量"]);
        //                            paramMsg += Utils.VerifyRequired("动力蓄电池组比能量", fcdsInfo.FCDS_HHDL_DLXDCBNL);

        //                            fcdsInfo.FCDS_HHDL_CDDMSXZHGKXSLC = Convert.ToString(r["纯电动模式下综合工况续驶里程"]);
        //                            if (!string.IsNullOrEmpty(fcdsInfo.FCDS_HHDL_CDDMSXZHGKXSLC))
        ...
        //                            fcdsInfo.FCDS_HHDL_DLXDCZBCDY = Convert.ToString(r["动力蓄电池组标称电压"]);
        //                            paramMsg += Utils.VerifyRequired("动力蓄电池组标称电压", fcdsInfo.FCDS_HHDL_DLXDCZBCDY);

        //                            fcdsInfo.FCDS_HHDL_QDDJLX = Convert.ToString(r["驱动电机类型"]);
        //                            paramMsg += Utils.VerifyRequired("驱动电机类型", fcdsInfo.FCDS_HHDL_QDDJLX);

        //                            fcdsInfo.FCDS_HHDL_HHDLZDDGLB = Convert.ToString(r["混合动力最大电功率比"]);
        //                            paramMsg += Utils.VerifyRequired("混合动力最大电功率比", fcdsInfo.FCDS_HHDL_HHDLZDDGLB);

        //                            fcdsInfo.FCDS_HHDL_QDDJFZNJ = Convert.ToString(r["驱动电机峰值扭矩"]);
        //                            paramMsg += Utils.VerifyRequired("驱动电机峰值扭矩", fcdsInfo.FCDS_HHDL_QDDJFZNJ);
