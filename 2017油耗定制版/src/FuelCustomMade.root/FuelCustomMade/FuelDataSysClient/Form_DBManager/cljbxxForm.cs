...
namespace FuelDataSysClient.Form_DBManager
{
    public partial class cljbxxForm : Form
    {
        ...
        {
            string strVid = "";
            string strSql = String.Format("SELECT V_ID FROM FC_CLJBXX WHERE VIN ='{0}'", strBah.ToUpper());
        ...
        {
            bool flgSave = false;
            string sqlJbxx = String.Format("SELECT * FROM FC_CLJBXX WHERE VIN = '{0}' AND STATUS='1'", strBah);
