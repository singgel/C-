...
namespace FuelDataSysClient.FuelDataOpen {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="FuelDataOpenSoap", Namespace="http://tempuri.org/")]
    public partial class FuelDataOpen : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public FuelDataOpen() {
            this.Url = global::FuelDataSysClient.Properties.Settings.Default.FuelDataSysClient_FuelDataOpen_FuelDataOpen;
        ...
        public bool Open(string userId, string passWd, string oKey, string actionType) {
        ...
        /// <remarks/>
        public void OpenAsync(string userId, string passWd, string oKey, string actionType) {
            this.OpenAsync(userId, passWd, oKey, actionType, null);
        }
        
        /// <remarks/>
        public void OpenAsync(string userId, string passWd, string oKey, string actionType, object userState) {
            ...
            this.InvokeAsync("Open", new object[] {
                        ...
                        passWd,
                        oKey,
                        actionType}, this.OpenOperationCompleted, userState);
        }
        ...
        public bool Close(string userId, string passWd, string key, string actionType) {
        ...
        /// <remarks/>
        public void CloseAsync(string userId, string passWd, string key, string actionType) {
            this.CloseAsync(userId, passWd, key, actionType, null);
        }
        
        /// <remarks/>
        public void CloseAsync(string userId, string passWd, string key, string actionType, object userState) {
            ...
            this.InvokeAsync("Close", new object[] {
                        ...
                        passWd,
                        key,
                        actionType}, this.CloseOperationCompleted, userState);
        }
