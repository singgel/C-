...
namespace Catarc.Adc.NewEnergyAccountSys.DBUtils
{
    ...
    {
        //数据库连接字符串
        public static readonly string conn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\\data\\data.mdb;Persist Security Info=True";
        //public static readonly string conn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\\data\\data.mdb;;Persist Security Info=True;User ID=admin;Password=;Jet OLEDB:Database Password=adc-soft";
        // 用于缓存参数的HASH表
        ...
        {
            object obj = AccessHelper.GetSingle(connectionString, cmdText);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        private static void DataSetToAccess(string connectionString, string cmdtext, DataTable datasource)
        {
            OleDbCommand cmd = new OleDbCommand();
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
