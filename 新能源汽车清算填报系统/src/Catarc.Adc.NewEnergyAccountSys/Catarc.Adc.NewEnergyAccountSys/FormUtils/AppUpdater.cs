...
namespace Catarc.Adc.NewEnergyAccountSys.FormUtils
{
    ...
    public class AppUpdater : IDisposable
    {
        ...
        public int CheckForUpdate()
        {
            ...
            {
                localXmlFile = Application.StartupPath + "\\UpdateList_Ent.xml";
            }
            else
            {
            ...
            if (Settings.Default.AuthorityUrl.Equals(@"\Template\Authority.XML"))
            {
                this.UpdaterUrl = updaterXmlFiles.GetNodeValue("//Url") + "/UpdateList_Ent.xml";
            }
            else
            {
        ...
        public void DownAutoUpdateFile(string downpath)
        {
            ...
            if (Settings.Default.AuthorityUrl.Equals(@"\Template\Authority.XML"))
            {
                serverXmlFile = downpath + @"/UpdateList_Ent.xml";
            }
            else
            {
