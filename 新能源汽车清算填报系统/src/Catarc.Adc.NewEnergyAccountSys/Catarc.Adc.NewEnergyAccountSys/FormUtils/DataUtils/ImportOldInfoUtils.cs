...
{
    public class ImportOldInfoUtils
    {
        ...
        /// <returns></returns>
        public string ImportOldTemplate(string floderPath)
        {
            ...
            msg += String.Format("请注意：Ekg值、车辆性质、公告批次无法通过旧模板导入系统中{0}", Environment.NewLine);
            return msg;
        }
        ...
        private DataTable readExcelTemplate2(string filePath)
        {
            ...
            for (int i = 4; i < dt2.Rows.Count; i++)
            {
                ...
                dtTemp2.Rows.Add();
                dtTemp2.Rows[i - 4][0] = dt2.Rows[i][2].ToString().Trim();
                dtTemp2.Rows[i - 4][1] = dt2.Rows[i][3].ToString().Trim();
                dtTemp2.Rows[i - 4][2] = dt2.Rows[i][4].ToString().Trim();
                dtTemp2.Rows[i - 4][3] = dt2.Rows[i][5].ToString().Trim();
                dtTemp2.Rows[i - 4][4] = dt2.Rows[i][6].ToString().Trim();
                dtTemp2.Rows[i - 4][5] = dt2.Rows[i][7].ToString().Trim();
                dtTemp2.Rows[i - 4][6] = dt2.Rows[i][8].ToString().Trim();
                dtTemp2.Rows[i - 4][7] = dt2.Rows[i][9].ToString().Trim();
                dtTemp2.Rows[i - 4][8] = dt2.Rows[i][10].ToString().Trim();
                dtTemp2.Rows[i - 4][9] = dt2.Rows[i][11].ToString().Trim();
                dtTemp2.Rows[i - 4][10] = String.Format("{0}/{1}/{2}", dt2.Rows[i][12].ToString().Trim(), dt2.Rows[i][13].ToString().Trim().Length == 2 ? dt2.Rows[i][13].ToString().Trim() : "0" + dt2.Rows[i][13].ToString().Trim(), dt2.Rows[i][14].ToString().Trim().Length == 2 ? dt2.Rows[i][14].ToString().Trim() : "0" + dt2.Rows[i][14].ToString().Trim());
                dtTemp2.Rows[i - 4][11] = String.Format("{0}/{1}/{2}", dt2.Rows[i][15].ToString().Trim(), dt2.Rows[i][16].ToString().Trim().Length == 2 ? dt2.Rows[i][16].ToString().Trim() : "0" + dt2.Rows[i][16].ToString().Trim(), dt2.Rows[i][17].ToString().Trim().Length == 2 ? dt2.Rows[i][17].ToString().Trim() : "0" + dt2.Rows[i][17].ToString().Trim());
                dtTemp2.Rows[i - 4][12] = dt2.Rows[i][18].ToString().Trim().Split('|').Length > 1 || dt2.Rows[i][19].ToString().Trim().Split('|').Length > 1 || dt2.Rows[i][20].ToString().Trim().Split('|').Length > 1 || dt2.Rows[i][21].ToString().Trim().Split('|').Length > 1 || dt2.Rows[i][22].ToString().Trim().Split('|').Length > 1 || dt2.Rows[i][23].ToString().Trim().Split('|').Length > 1 || dt2.Rows[i][24].ToString().Trim().Split('|').Length > 1 ? "是" : "否";
                dtTemp2.Rows[i - 4][13] = dt2.Rows[i][18].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][18].ToString().Trim().Split('|')[0] : dt2.Rows[i][18].ToString().Trim();
                dtTemp2.Rows[i - 4][14] = dt2.Rows[i][18].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][18].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][15] = dt2.Rows[i][19].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][19].ToString().Trim().Split('|')[0] : dt2.Rows[i][19].ToString().Trim();
                dtTemp2.Rows[i - 4][16] = dt2.Rows[i][19].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][19].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][17] = dt2.Rows[i][20].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][20].ToString().Trim().Split('|')[0] : dt2.Rows[i][20].ToString().Trim();
                dtTemp2.Rows[i - 4][18] = dt2.Rows[i][20].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][20].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][19] = dt2.Rows[i][21].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][21].ToString().Trim().Split('|')[0] : dt2.Rows[i][21].ToString().Trim();
                dtTemp2.Rows[i - 4][20] = dt2.Rows[i][21].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][21].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][21] = dt2.Rows[i][22].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][22].ToString().Trim().Split('|')[0] : dt2.Rows[i][22].ToString().Trim();
                dtTemp2.Rows[i - 4][22] = dt2.Rows[i][22].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][22].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][23] = dt2.Rows[i][23].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][23].ToString().Trim().Split('|')[0] : dt2.Rows[i][23].ToString().Trim();
                dtTemp2.Rows[i - 4][24] = dt2.Rows[i][23].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][23].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][25] = dt2.Rows[i][24].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][24].ToString().Trim().Split('|')[0] : dt2.Rows[i][24].ToString().Trim();
                dtTemp2.Rows[i - 4][26] = dt2.Rows[i][24].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][24].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][27] = dt2.Rows[i][25].ToString().Trim().Split('|').Length > 1 || dt2.Rows[i][26].ToString().Trim().Split('|').Length > 1 || dt2.Rows[i][27].ToString().Trim().Split('|').Length > 1 || dt2.Rows[i][28].ToString().Trim().Split('|').Length > 1 ? "是" : "否";
                dtTemp2.Rows[i - 4][28] = dt2.Rows[i][25].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][25].ToString().Trim().Split('|')[0] : dt2.Rows[i][25].ToString().Trim();
                dtTemp2.Rows[i - 4][29] = dt2.Rows[i][25].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][25].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][30] = dt2.Rows[i][26].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][26].ToString().Trim().Split('|')[0] : dt2.Rows[i][26].ToString().Trim();
                dtTemp2.Rows[i - 4][31] = dt2.Rows[i][26].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][26].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][32] = dt2.Rows[i][27].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][27].ToString().Trim().Split('|')[0] : dt2.Rows[i][27].ToString().Trim();
                dtTemp2.Rows[i - 4][33] = dt2.Rows[i][27].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][27].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][34] = dt2.Rows[i][28].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][28].ToString().Trim().Split('|')[0] : dt2.Rows[i][28].ToString().Trim();
                dtTemp2.Rows[i - 4][35] = dt2.Rows[i][28].ToString().Trim().Split('|').Length > 1 ? dt2.Rows[i][28].ToString().Trim().Split('|')[1] : string.Empty;
                dtTemp2.Rows[i - 4][36] = !string.IsNullOrEmpty(dt2.Rows[i][29].ToString().Trim()) || !string.IsNullOrEmpty(dt2.Rows[i][30].ToString().Trim()) || !string.IsNullOrEmpty(dt2.Rows[i][31].ToString().Trim()) || !string.IsNullOrEmpty(dt2.Rows[i][32].ToString().Trim()) || !string.IsNullOrEmpty(dt2.Rows[i][33].ToString().Trim()) ? "是" : "否";
                dtTemp2.Rows[i - 4][37] = dt2.Rows[i][29].ToString().Trim();
                dtTemp2.Rows[i - 4][38] = dt2.Rows[i][30].ToString().Trim();
                dtTemp2.Rows[i - 4][39] = dt2.Rows[i][31].ToString().Trim();
                dtTemp2.Rows[i - 4][40] = dt2.Rows[i][32].ToString().Trim();
                dtTemp2.Rows[i - 4][41] = dt2.Rows[i][33].ToString().Trim();
                dtTemp2.Rows[i - 4][42] = dt2.Rows[0][0].ToString().Trim().Length > 4 ? dt2.Rows[0][0].ToString().Trim().Substring(0, 4) : string.Empty;
                dtTemp2.Rows[i - 4][43] = dicCity.ContainsKey(dt2.Rows[i][2].ToString().Trim()) ? dicCity[dt2.Rows[i][2].ToString().Trim()] : string.Empty;
                string vin = dt2.Rows[i][7].ToString().Trim();
                dtTemp2.Rows[i - 4][44] = File.Exists(Path.Combine(Utils.billImage, String.Format("车辆发票VIN-{0}.jpg", vin))) ? String.Format("车辆发票VIN-{0}.jpg", vin) : string.Empty;
                dtTemp2.Rows[i - 4][45] = File.Exists(Path.Combine(Utils.billImage, String.Format("车辆发票VIN-{0}.jpg", vin))) ? String.Format("车辆发票VIN-{0}.jpg", vin) : string.Empty;
                dtTemp2.Rows[i - 4][46] = File.Exists(Path.Combine(Utils.driveImage, String.Format("行驶证VIN-{0}.jpg", vin))) ? String.Format("行驶证VIN-{0}.jpg", vin) : string.Empty;
                dtTemp2.Rows[i - 4][47] = File.Exists(Path.Combine(Utils.driveImage, String.Format("行驶证VIN-{0}.jpg", vin))) ? String.Format("行驶证VIN-{0}.jpg", vin) : string.Empty;
            }
            return dtTemp2;
        }
        ...
        private DataTable readExcelTemplate3(string filePath)
        {
            ...
            for (int i = 4; i < dt3.Rows.Count; i++)
            {
                ...
                dtTemp3.Rows.Add();
                dtTemp3.Rows[i - 4][0] = dt3.Rows[i][2].ToString().Trim();
                dtTemp3.Rows[i - 4][1] = dt3.Rows[i][3].ToString().Trim();
                dtTemp3.Rows[i - 4][2] = dt3.Rows[i][4].ToString().Trim();
                dtTemp3.Rows[i - 4][3] = dt3.Rows[i][5].ToString().Trim();
                dtTemp3.Rows[i - 4][4] = dt3.Rows[i][6].ToString().Trim();
                dtTemp3.Rows[i - 4][5] = dt3.Rows[i][7].ToString().Trim();
                dtTemp3.Rows[i - 4][6] = dt3.Rows[i][8].ToString().Trim();
                dtTemp3.Rows[i - 4][7] = dt3.Rows[i][9].ToString().Trim();
                dtTemp3.Rows[i - 4][8] = dt3.Rows[i][10].ToString().Trim();
                dtTemp3.Rows[i - 4][9] = dt3.Rows[i][11].ToString().Trim();
                dtTemp3.Rows[i - 4][10] = dt3.Rows[i][12].ToString().Trim();
                dtTemp3.Rows[i - 4][11] = dt3.Rows[i][13].ToString().Trim();
                dtTemp3.Rows[i - 4][12] = dt3.Rows[i][14].ToString().Trim();
                dtTemp3.Rows[i - 4][13] = dt3.Rows[i][15].ToString().Trim();
                dtTemp3.Rows[i - 4][14] = dt3.Rows[i][16].ToString().Trim();
                dtTemp3.Rows[i - 4][15] = dt3.Rows[i][17].ToString().Trim();
                dtTemp3.Rows[i - 4][16] = dt3.Rows[i][18].ToString().Trim();
                dtTemp3.Rows[i - 4][17] = dt3.Rows[i][19].ToString().Trim();
            }
            return dtTemp3;
        }
