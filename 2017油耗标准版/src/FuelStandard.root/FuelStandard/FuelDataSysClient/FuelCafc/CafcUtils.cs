		        ...
		        SELECT T2.QCSCQY,T2.CLXH,T2.QYID,T2.ZCZBZL,T2.BSQXS,T2.ZWPS,T2.ZHGKXSLC,
			        ...
			        CASE WHEN (T2.RLLX='纯电动' OR T2.RLLX='燃料电池' OR 
				        (T2.RLLX='插电式混合动力' AND T2.ZHGKXSLC>=50)) THEN SUM(T2.SL)*5
				         WHEN (T2.RLLX='汽油' OR T2.RLLX='柴油' OR T2.RLLX='柴油'  OR T2.RLLX='两用燃料'  OR T2.RLLX='双燃料' OR T2.RLLX='气体燃料' OR T2.RLLX='非插电式混合动力') 
            ...
            sqlBasic = string.Format(@"SELECT T.QCSCQY AS 汽车企业名称, T.QYLX AS 企业类型, 
                                ...
                                (
	                                ...
	                                (
		                                ...
		                                FROM HS_JHB
		                                WHERE CLZL='乘用车（M1）' AND (RLLX='汽油' OR RLLX='柴油' OR RLLX='双燃料' OR RLLX='气体燃料' OR RLLX='两用燃料' OR RLLX='非插电式混合动力') {0}
            ...
            sqlBasic = string.Format(@"SELECT 	 T.QCSCQY,SUM(T.SL) AS SL,
                                ...
                                (
	                                ...
	                                (
		                                ...
		                                FROM HS_FORECAST
		                                WHERE (RLLX='汽油' OR RLLX='柴油' OR RLLX='双燃料' OR RLLX='气体燃料' OR RLLX='两用燃料' OR RLLX='非插电式混合动力')
